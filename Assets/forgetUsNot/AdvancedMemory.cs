...
public class AdvancedMemory : MonoBehaviour
{
    ...
    private int getCode(string s)
    {
        ...
        switch (s)
        {
            ...
            case ("Vigenére Cipher"): r = 159; break;
            ...
            case ("Caesar's Maths"): r = 122; break;
            ...
            case ("KayMazey Talk"): r = 223; break;
            ...
            case ("Shifted Maze"): r = 324; break;
            case ("Juxtacolored Squares"): r = 835; break;
            case ("Wolf, Goat, and Cabbage"): r = 924; break;
            case ("The Missing Letter"): r = 893; break;
            case ("Amnesia"): r = 904; break;
            case ("Plug-Ins"): r = 934; break;
            case ("Synesthesia"): r = 787; break;
            case ("English Entries"): r = 695; break;
            case ("The Duck"): r = 894; break;
            case ("The Cruel Duck"): r = 895; break;
            case ("Identifying Soulless"): r = 533; break;
            case ("Ultimate Tic Tac Toe"): r = 196; break;
            case ("Factoring"): r = 698; break;
            case ("Lyrical Nonsense"): r = 130; break;
            case ("RGB Sequences"): r = 023; break;
            case ("Puzzword"): r = 598; break;
            case ("NOT NOT"): r = 090; break;
            case ("Repo Selector"): r = 515; break;
            case ("int##"): r = 091; break;
            case ("Deaf Alley"): r = 758; break;
            case ("Blind Arrows"): r = 061; break;
            case ("Sound Design"): r = 786; break;
            case ("RGB Arithmetic"): r = 094; break;
            case ("D-CODE"): r = 878; break;
            case ("Fifteen"): r = 239; break;
            case ("Pixel Cipher"): r = 182; break;
            case ("The Great Void"): r = 896; break;
            case ("21"): r = 413; break;
            case ("The Calculator"): r = 897; break;
            case ("Prime Time"): r = 735; break;
            case ("Negation"): r = 736; break;
            case ("SixTen"): r = 093; break;
            case ("Ultralogic"): r = 092; break;
            case ("Spangled Stars"): r = 767; break;
            case ("Cruel Match 'em"): r = 428; break;
            case ("Assembly Code"): r = 879; break;
            case ("Simon's Ultimate Showdown"): r = 773; break;
            case ("Boomdas"): r = 376; break;
            case ("Needlessly Complicated Button"): r = 117; break;
            case ("Color Numbers"): r = 391; break;
            case ("Chinese Strokes"): r = 375; break;
            case ("Chalices"): r = 289; break;
            case ("Pixel Art"): r = 078; break;
            case ("Faulty Accelerando"): r = 088; break;
            case ("0"): r = 419; break;
            case ("Increasing Indices"): r = 696; break;
            case ("Faulty Binary"): r = 039; break;
            case ("Cruel Binary"): r = 038; break;
            case ("Connected Monitors"): r = 877; break;
            case ("Broken Binary"): r = 037; break;
            case ("Totally Accurate Minecraft Simulator"): r = 334; break;
            case ("Tell Me When"): r = 444; break;
            case ("ReGret-B Filtering"): r = 095; break;
            case ("D-CRYPT"): r = 888; break;
            case ("Color-Cycle Button"): r = 392; break;
            case ("Alien Filing Colors"): r = 393; break;
            case ("The Kanye Encounter"): r = 995; break;
            case ("Entry Number Four"): r = 249; break;
            case ("D-CIPHER"): r = 188; break;
            case ("501"): r = 439; break;
            case ("42"): r = 437; break;
            case ("Color One Two"): r = 394; break;
            case ("Toolmods"): r = 516; break;
            case ("Spelling Buzzed"): r = 595; break;
            case ("Burnout"): r = 916; break;
            case ("Brown Bricks"): r = 489; break;
            case ("Mystic Maze"): r = 339; break;
            case ("Chinese Zodiac"): r = 597; break;
            case ("Four Lights"): r = 409; break;
            case ("Working Title"): r = 739; break;
            case ("One Links To All"): r = 438; break;
            case ("Rules"): r = 276; break;
            case ("Tenpins"): r = 577; break;
            ...
            case ("Colored Buttons"): r = 137; break;
            case ("Censorship"): r = 268; break;
            case ("The Pentabutton"): r = 138; break;
            case ("Mechanus Cipher"): r = 183; break;
            case ("Digisibility"): r = 936; break;
            case ("Breaktime"): r = 954; break;
            case ("Mazery"): r = 338; break;
            case ("Kim's Game"): r = 476; break;
            case ("Three Cryptic Steps"): r = 277; break;
            case ("Popufur"): r = 229; break;
            case ("Space"): r = 948; break;
            case ("9-Ball"): r = 408; break;
            case ("Metamen"): r = 568; break;
            case ("M&Ms"): r = 228; break;
            case ("The Console"): r = 898; break;
            case ("Pocket Planes"): r = 927; break;
            case ("Bridge"): r = 846; break;
            case ("Rotten Beans"): r = 350; break;
            case ("Long Beans"): r = 351; break;
            case ("Jellybeans"): r = 352; break;
            case ("Cool Beans"): r = 353; break;
            case ("Beans"): r = 354; break;
            case ("Beanboozled Again"): r = 355; break;
            case ("The Dials"): r = 899; break;
            case ("Butterflies"): r = 455; break;
            case ("Broken Karaoke"): r = 884; break;
            case ("Chamber No. 5"): r = 407; break;
            case ("Silenced Simon"): r = 798; break;
            case ("Teal Arrows"): r = 062; break;
            case ("Keep Clicking"): r = 488; break;
            case ("Frankenstein's Indicator"): r = 298; break;
            case ("16 Coins"): r = 406; break;
            case ("Alphabet Tiles"): r = 216; break;
            case ("Double Pitch"): r = 747; break;
            case ("Devilish Eggs"): r = 587; break;
            case ("h"): r = 405; break;
            case ("Quick Time Events"): r = 935; break;
            case ("Iñupiaq Numerals"): r = 946; break;
            case ("The Bioscanner"): r = 908; break;
            case ("Ars Goetia Identification"): r = 534; break;
            case ("Pixel Number Base"): r = 997; break;
            case ("Silo Authorization"): r = 486; break;
            case ("Gradually Watermelon"): r = 796; break;
            case ("Mastermind Restricted"): r = 466; break;
            case ("Logical Operators"): r = 887; break;
            case ("Higher Or Lower"): r = 759; break;
            case ("Even Or Odd"): r = 047; break;
            case ("Digital Grid"): r = 945; break;
            case ("Reformed Role Reversal"): r = 045; break;
            case ("Whiteout"): r = 957; break;
            case ("N&Ns"): r = 258; break;
            case ("Gettin' Funky"): r = 266; break;
            case ("Cell Lab"): r = 485; break;
            case ("Color Hexagons"): r = 396; break;
            case ("Commuting"): r = 949; break;
            case ("Symmetries Of A Square"): r = 928; break;
            case ("Look and Say"): r = 794; break;
            case ("Currents"): r = 937; break;
            case ("Partitions"): r = 269; break;
            case ("Telepathy"): r = 458; break;
            case ("Cruel Stars"): r = 379; break;
            case ("Button Messer"): r = 089; break;
            case ("Taco Tuesday"): r = 045; break;
            case ("Nomai"): r = 487; break;
            case ("Table Madness"): r = 344; break;
            case ("Melodic Message"): r = 262; break;
            case ("Sugar Skulls"): r = 265; break;
            case ("Cosmic"): r = 478; break;
            case ("Semabols"): r = 574; break;
            case ("Mislocation"): r = 768; break;
            case ("Musher The Batten"): r = 434; break;
            case ("Tribal Council"): r = 926; break;
            case ("Simon Smiles"): r = 816; break;
            case ("Outrageous"): r = 219; break;
            case ("Faulty Chinese Counting"): r = 475; break;
            case ("Press The Shape"): r = 914; break;
            case ("Baybayin Words"): r = 538; break;
            case ("Going Backwards"): r = 323; break;
            case ("Atbash Cipher"): r = 180; break;
            case ("Venn Diagrams"): r = 912; break;
            case ("Numbered Buttons"): r = 097; break;
            case ("Colored Hexabuttons"): r = 089; break;
            case ("Video Poker"): r = 549; break;
            case ("White Arrows"): r = 063; break;
            case ("Johnson Solids"): r = 468; break;
            case ("Bottom Gear"): r = 784; break;
            case ("Two Persuasive Buttons"): r = 079; break;
            case ("% Grey"): r = 399; break;
            case ("Towers"): r = 848; break;
            case ("Letter Layers"): r = 217; break;
            case ("The Exploding Pen"): r = 909; break;
            case ("Snack Attack"): r = 267; break;
            case ("ReGrettaBle Relay"): r = 135; break;
            case ("Standard Button Masher"): r = 136; break;
            case ("Musical Transposition"): r = 134; break;
            case ("Jackbox.TV"): r = 279; break;
            case ("The Furloid Jukebox"): r = 885; break;
            case ("The Close Button"): r = 116; break;
            case ("Updog"): r = 043; break;
            case ("Saimoe Pad"): r = 447; break;
            case ("B-Machine"): r = 573; break;
            case ("Addition"): r = 719; break;
            case ("What's on Second"): r = 042; break;
            case ("Quaver"): r = 377; break;
            case ("Another Keypad Module"): r = 214; break;
            case ("Rhythm Test"): r = 262; break;
            case ("Bad Wording"): r = 296; break;
            case ("Etch-A-Sketch"): r = 925; break;
            case ("Diophantine Equations"): r = 737; break;
            case ("Ternary Tiles"): r = 263; break;
            case ("Striped Keys"): r = 968; break;
            case ("Rullo"): r = 845; break;
            case ("Flashing Arrows"): r = 064; break;
            case ("Cruello"): r = 938; break;
            case ("Coloured Arrows"): r = 065; break;
            case ("Tetris Sprint"): r = 448; break;
            case ("Double Screen"): r = 469; break;
            case ("The Sequencyclopedia"): r = 907; break;
            case ("eeB gnillepS"): r = 588; break;
            case ("Pandemonium Cipher"): r = 184; break;
            case ("Mineswapper"): r = 745; break;
            case ("Phosphorescence"): r = 795; break;
            case ("The Klaxon"): r = 906; break;
            case ("Valued Keys"): r = 969; break;
            case ("Numerical Knight Movement"): r = 295; break;
            case ("Bandboozled Again"): r = 197; break;
            case ("SpriteClub Betting Simulation"): r = 913; break;
            case ("Ramboozled Again"): r = 139; break;
            case ("Simon Subdivides"): r = 817; break;
            case ("Hole in One"): r = 576; break;
            case ("Hexiom"): r = 886; break;
            case ("Back Buttons"): r = 066; break;
            case ("Audio Keypad"): r = 213; break;
            case ("Saimoe Maze"): r = 337; break;
            case ("Kidney Beans"): r = 356; break;
            case ("Fake Beans"): r = 357; break;
            case ("Chilli Beans"): r = 358; break;
            case ("Big Bean"): r = 359; break;
            case ("Bean Sprouts"): r = 369; break;
            case ("Tell Me Why"): r = 483; break;
            case ("Quiplash"): r = 278; break;
            case ("Bowling"): r = 579; break;
            case ("Sporadic Segments"): r = 025; break;
            case ("Linq"): r = 299; break;
            case ("Entry Number One"): r = 436; break;
            case ("DNA Mutation"): r = 457; break;
            case ("RGB Hypermaze"): r = 336; break;
            case ("Boob Tube"): r = 797; break;
            case ("Regular Sudoku"): r = 738; break;
            case ("Polyrhythms"): r = 746; break;
            case ("Drive-In Window"): r = 918; break;
            case ("Y"): r = 445; break;
            case ("X"): r = 446; break;
            case ("The Xenocryst"): r = 837; break;
            case ("Rebooting M-OS"): r = 044; break;
            case ("Stacked Sequences"): r = 024; break;
            case ("Complexity"): r = 218; break;
            case ("Small Circle"): r = 378; break;
            case ("Fractal Maze"): r = 349; break;
            case ("Simon Stumbles"): r = 818; break;
            case ("Wild Side"): r = 477; break;
            case ("The Octadecayotton"): r = 836; break;
            case ("Colored Letters"): r = 397; break;
            case ("Kahoot!"): r = 947; break;
            case ("Ultra Digital Root"): r = 959; break;
            case ("Mii Identification"): r = 535; break;
            case ("81"): r = 435; break;
            case ("Simon Swindles"): r = 799; break;
            case ("Next In Line"): r = 956; break;
            case ("Functional Mapping"): r = 575; break;
            case ("Stable Time Signatures"): r = 041; break;
            case ("Keypad Maze"): r = 349; break;
            case ("Astrological"): r = 259; break;
            case ("XmORse Code"): r = 529; break;
            case ("Corridors"): r = 467; break;
            case ("Decay"): r = 847; break;
            case ("Large Password"): r = 564; break;
            case ("Large Free Password"): r = 565; break;
            case ("Free Password"): r = 566; break;
            case ("Not Timer"): r = 049; break;
            case ("The Burnt"): r = 769; break;
            case ("Access Codes"): r = 456; break;
            case ("Cistercian Numbers"): r = 958; break;
            case ("Brown Cipher"): r = 185; break;
            case ("Code Cracker"): r = 026; break;
            case ("Indentation"): r = 939; break;
            case ("One-Line"): r = 537; break;
            case ("The Speaker"): r = 905; break;
            case ("Interpunct"): r = 915; break;
            case ("Name Codes"): r = 567; break;
            case ("The 1, 2, 3 Game"): r = 449; break;
            case ("Papa's Pizzeria"): r = 275; break;
            case ("Keypad Magnified"): r = 215; break;
            case ("Hold On"): r = 539; break;
            case ("Diffusion"): r = 559; break;
            case ("Soy Beans"): r = 368; break;
            case ("The Shaker"): r = 345; break;
            case ("Coffee Beans"): r = 367; break;
            case ("Newline"): r = 955; break;
            case ("Letter Grid"): r = 048; break;
            case ("Ghost Movement"): r = 482; break;
            case ("Transmission Transposition"): r = 919; break;
            case ("RSA Cipher"): r = 199; break;
            case ("Amusement Parks"): r = 929; break;
            case ("Literally Something"): r = 917; break;
            case ("Icon Reveal"): r = 749; break;
            case ("Solitaire Cipher"): r = 198; break;
            case ("hexOrbits"): r = 849; break;
            case ("Matchmaker"): r = 479; break;
            case ("Ladders"): r = 569; break;
            case ("Decimation"): r = 297; break;
            case ("Count to 69420"): r = 459; break;
            case ("Mssngv Wls"): r = 347; break;
            case ("Netherite"): r = 346; break;
            case ("Naming Conventions"): r = 944; break;
            case ("I'm Not a Robot"): r = 528; break;
            case ("Emoticon Math"): r = 679; break;
            case ("Coinage"): r = 536; break;
            case ("Simon Supports"): r = 819; break;
            default: r = 998; break;
        }
        return r;
    }
